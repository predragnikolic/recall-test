  ...
  return (
    <div className="h-[100vh] w-full flex justify-center items-center dark">
      <div className="flex flex-col items-center">
        ...
        <p className="text-center mb-9 text-small uppercase tracking-widest text-small">books matter</p>
        <Card className="p-6 flex flex-col gap-6 w-full max-w-[369px]">
          <div className="flex justify-between">
            <h1 className="text-3xl nice-font font-bold bg-transparent transition-all">Sign In</h1>
          </div>
          ...
          <form className="contents" onSubmit={signIn}>
            ...
            <Button type="submit" color="primary" className="uppercase font-bold nice-font tracking-widest">
              Sign in
            </Button>
          </form>
        </Card>
