	...
	return (
		<div className="h-[100vh] w-full flex justify-center items-center">
			<div className="flex flex-col items-center">
				...
				<p className="text-center mb-9 text-small">
					Sign in or create an account to get going
				</p>
					...
					<div className="flex justify-between">
						<Button
							...
							className={classNames(
								"text-3xl nice-font font-bold bg-transparent transition-all",
								tab === "SIGN_UP" && inactiveTabClasses,
							)}
						>
							Sign In
						</Button>
						<Button
							...
							className={classNames(
								"text-3xl nice-font font-bold bg-transparent transition-all",
								tab === "SIGN_IN" && inactiveTabClasses,
							)}
						>
							Sign Up
						</Button>
